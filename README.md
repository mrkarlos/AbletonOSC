...
| /live/device/get/is_active               | track_id, device_id                      | track_id, device_id, is_active           | Get device enabled state (1 = enabled, 0 = bypassed)                                   |
| /live/device/set/is_active               | track_id, device_id, is_active           |                                          | Set device enabled state                                                                |
